...
<div class="col-md-4 col-sm-6 col-xs-12">
    <?= $search->field('vrf')->dropDownList($this->context->getRefs('type,ip_vrf', 'hipanel.ipam'), ['prompt' => $search->model->getAttributeLabel('vrf')]) ?>
</div>

<div class="col-md-4 col-sm-6 col-xs-12">
    <?= $search->field('role')->dropDownList($this->context->getRefs('type,ip_prefix_role', 'hipanel.ipam'), ['prompt' => $search->model->getAttributeLabel('role')]) ?>
</div>
